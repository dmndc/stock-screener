...
class Dashboard extends Component {
  ...
  render() {
    ...
    console.log('PERCENTAGE: ', sectorData);
    ...
    let latestPrice = numeral(this.state.quote.latestPrice).format('000.0');
      ...
      <div className="container">
          ...
          <div className="row mb-3">
            <div className="col-sm">
              <List title="Best Performers" class="top-list card rounded-0" icon="oi oi-arrow-thick-top mr-3" source="gainers" />
            </div>
            <div className="col-sm">
              <List title="Worst Performers" class="top-list card rounded-0" icon="oi oi-arrow-thick-bottom mr-3" source="losers" />
            </div>
            <div className="col-sm">
              {this.state.auth_id !== null ? <WatchList /> : <List title="Most Active" class="card rounded-0" icon="oi oi-bar-chart mr-3" source="volume" />}
          ...
          <div className="row mb-5">
            <div className="col-sm-8">
              <div className="card text-white bg-dark rounded-0">
                ...
                <div className="card-body">
                  ...
                  <h6 class="card-subtitle mb-2 text-muted">YTD Percent Change</h6>
            ...
            <div className="col-sm">
              {this.state.auth_id !== null ? <List title="Most Active" class="card rounded-0" icon="oi oi-bar-chart mr-3" source="volume" /> : null}
